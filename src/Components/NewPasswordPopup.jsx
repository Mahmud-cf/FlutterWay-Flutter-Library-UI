    ...
    <div className="the-pop-up fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="log-in-welcome text-center">
          ...
          <p className="text-xs sm:text-sm text-lite mb-4 dark:text-white">
        ...
        <form>
          ...
          <a href="#">
            <div
              type="submit"
              className="bg-black button-h dark:text-black dark:bg-white text-center full-size hover:bg-slate-900 rounded-xl  text-white font-bold py-2 my-3 px-4"
            >
              Sand Code
            </div>
          </a>
